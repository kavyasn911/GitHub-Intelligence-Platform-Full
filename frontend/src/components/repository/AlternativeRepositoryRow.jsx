...
import { Package, StarOutline, FormDown, FormUp, Favorite, Github, DocumentText } from "grommet-icons";
import { ScoreRing } from "../common/ScoreRing";
import { RepositoryIntelligenceContent } from "./RepositoryIntelligencePanel";
import { formatCount, timeAgo } from "../../utils/format";

export function AlternativeRepositoryRow({ repository, isSaved, onToggleSave }) {
      ...
      >
        ...
        <Box direction="row" align="center" gap="medium">
          ...
          <Button
            ...
            icon={<Favorite color={isSaved ? "accent-1":"text-tertiary"} />}
          />
          ...
          <Button
            ...
            onClick={(e)=>{
              e.stopPropagation();
              navigate(`/repository/${repository.full_name}`, { state: { repository } });
            }}
          />
